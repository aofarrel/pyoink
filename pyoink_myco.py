...
#### download reports ####
subprocess.check_call(f'python3 ../helper_scripts/pyoink.py --submission_id {args.submission_id} --bucket {args.bucket} --workflow_id {args.workflow_id} --file "pull_reports.txt" --task "cat_reports" --not_scattered', 
...
subprocess.check_call(f'python3 ../helper_scripts/pyoink.py --submission_id {args.submission_id} --bucket {args.bucket} --workflow_id {args.workflow_id} --file "strain_reports.txt" --task "cat_strains" --not_scattered', 
                        shell=True, stdout=sys.stdout, stderr=subprocess.STDOUT)
...
subprocess.check_call(f'python3 ../helper_scripts/pyoink.py --submission_id {args.submission_id} --bucket {args.bucket} --workflow_id {args.workflow_id} --file "resistance_reports.txt" --task "cat_resistance" --not_scattered', 
                        shell=True, stdout=sys.stdout, stderr=subprocess.STDOUT)
...
subprocess.check_call(f'python3 ../helper_scripts/pyoink.py --submission_id {args.submission_id} --bucket {args.bucket} --workflow_id {args.workflow_id} --file "*.report"', 
                        shell=True, stdout=sys.stdout, stderr=subprocess.STDOUT)
...
subprocess.check_call(f'python3 ../helper_scripts/pyoink.py --submission_id {args.submission_id} --bucket {args.bucket} --workflow_id {args.workflow_id} --file "results/*.json" --task "profile"', 
                        shell=True, stdout=sys.stdout, stderr=subprocess.STDOUT)
...
subprocess.check_call(f'python3 ../helper_scripts/pyoink.py --submission_id {args.submission_id} --bucket {args.bucket} --workflow_id {args.workflow_id} --file "results/*.txt" --task "profile"', 
                        shell=True, stdout=sys.stdout, stderr=subprocess.STDOUT)
...
#### download diffs ####
subprocess.check_call(f'python3 ../helper_scripts/pyoink.py --submission_id {args.submission_id} --bucket {args.bucket} --workflow_id {args.workflow_id}', 
                        shell=True, stdout=sys.stdout, stderr=subprocess.STDOUT)
subprocess.run('mv downloaded_successfully.txt downloaded_successfully_diff.txt', shell=True)
print("Finished pulling diffs.")

#### download bedgraphs ####
subprocess.check_call(f'python3 ../helper_scripts/pyoink.py --submission_id {args.submission_id} --bucket {args.bucket} --workflow_id {args.workflow_id} --file "*.bedgraph"', 
                        shell=True, stdout=sys.stdout, stderr=subprocess.STDOUT)
...
#### download vcfs ####
subprocess.check_call(f'python3 ../helper_scripts/pyoink.py --submission_id {args.submission_id} --bucket {args.bucket} --workflow_id {args.workflow_id} --file "*.vcf" --task "varcall_with_array"', 
                        shell=True, stdout=sys.stdout, stderr=subprocess.STDOUT)
